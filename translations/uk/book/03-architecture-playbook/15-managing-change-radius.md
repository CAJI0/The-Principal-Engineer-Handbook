...
Second, contract became explicit. Every API Is a Promise (`LAW-002`) applied to record format, export file, service-tool view and diagnostic message. New reader accepted old records. New writer created new records only after manufacturing and service tools were updated. Downgrade behavior documented.
...
12. Which owner accepts residual radius?
