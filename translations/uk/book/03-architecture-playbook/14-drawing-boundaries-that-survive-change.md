...
Contract became explicit because Every API Is a Promise (`LAW-002`): product-level commands, accepted inputs, observable outcomes, completion semantics, failure categories, retry ownership, recovery handoff і lifecycle constraints.
...
Use this principle as review habit:
