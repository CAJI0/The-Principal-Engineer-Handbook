...
Команда замінила незалежні копії одним authoritative calibration contract. Додала check на divergence. Змінила ownership для station script. Додала рішення в ADR, щоб наступний engineer знав, чому ця межа існує.
...
Ця остання частина важлива. Незадокументоване інженерне судження не масштабується.
...
Команда може витратити тижні, покращуючи не те, якщо перше питання надто вузьке. «Чому це завдання падає?» може привести до local fix. «Чому це завдання може впасти, не залишивши доказів?» вказує на observability. «Чому дві частини системи можуть не погодитися про calibration?» вказує на ownership. «Чому release review це пропустив?» вказує на process.
...
Деякі рішення треба відкладати, бо команда ще не має достатньо доказів. Занадто раннє freezing створює false certainty. Воно перетворює guesses на architecture.
